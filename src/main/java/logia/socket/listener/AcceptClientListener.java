...
/**
 * The listener interface for receiving acceptClient events.
 * The class that is interested in processing a acceptClient
 * event implements this interface, and the object created
 * with that class is registered with a component using the
 * component's <code>addAcceptClientListener<code> method. When
